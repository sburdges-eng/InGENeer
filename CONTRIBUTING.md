...
1. Read **[AGENTS.md](AGENTS.md)** (agent entrypoint) and **[docs/governance/autonomation/AUTONOMATION_SYSTEM_ARCHITECTURE_RULES.md](docs/governance/autonomation/AUTONOMATION_SYSTEM_ARCHITECTURE_RULES.md)** / **[docs/governance/autonomation/LAYERED_PRACTICE_PLAYBOOK.md](docs/governance/autonomation/LAYERED_PRACTICE_PLAYBOOK.md)**.
